...
add_action( 'acf/include_fields', function() {
	...
	'key' => 'group_679e1324d8654',
	'title' => 'Gatvė',
	'fields' => array(
		array(
			'key' => 'field_679e1324144f0',
			'label' => 'Seniūnija',
			'name' => 'eldership_id',
			'aria-label' => '',
			'type' => 'post_object',
		...
		array(
			...
			'sub_fields' => array(
				...
				array(
					...
					'min' => 0,
					'max' => 0,
					'collapsed' => 'field_678245636dfc7',
					'button_label' => 'Pridėti gatvę',
					'rows_per_page' => 20,
					'sub_fields' => array(
						array(
	...
	'fields' => array(
		array(
			'key' => 'field_678cbb0b1ef94',
			'label' => 'Stotelės numeris',
			'name' => 'stop_number',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => '',
